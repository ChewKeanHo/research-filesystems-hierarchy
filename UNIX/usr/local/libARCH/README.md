...
Linux realm. Example: `/usr/local/lib32` for 32-bits CPU architecture library
files in a 64-bit CPU architecture operating system (OS).
...
**DEPRECATED AND REMOVED** in favor of using `/home/USERNAME/.local/libARCH`
instead.
