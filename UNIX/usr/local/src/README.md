...
This is the base directory for housing user custom supplied, non-critical source
files to extend its functionalities from *Full Catalogue* stage to *Complete*
stage. This means it can operate in `Multi-User` mode.
