...
user-specific, system administrators (sysadmin) and root account grade programs
and applications for extending the operating system (OS)'s functionalities from
*Complete* stage to *Personalized* stage. This means that executables in this
