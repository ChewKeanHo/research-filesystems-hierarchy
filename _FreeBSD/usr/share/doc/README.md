...
Generally, you **SHOULD ONLY** place distributor's registered documentation
files here. For your own locally build or custom sourced packages, you should
place them inside `/usr/local/share/doc` directory instead.
