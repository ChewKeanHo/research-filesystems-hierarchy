...
This directory houses all readily usable executables programs and applications
**ONLY FOR system administrators and root account**. They are designed to be as
readily usable terminal command. Conventional users should not be able to access
them except calling it from full path.
