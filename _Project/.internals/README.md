...
The naming is plural for seamless understanding (it has multiple internal
components).
...
Some technologies (notably Go) uses `internal` or `internals` naming
convention to denotes its private directories.
